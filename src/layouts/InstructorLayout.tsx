...
const InstructorLayout = () => {
  ...
  const navItems = [
    ...
    { name: "Messages", path: "/instructor/messages", icon: MessageCircle },
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <header className="bg-white shadow-sm py-4 px-6 flex justify-end items-center h-20 flex-shrink-0">
          {/* Mobile menu button */}
