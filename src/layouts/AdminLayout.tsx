...
//       <aside className="bg-green-100 w-full lg:w-64 lg:flex flex-col hidden lg:sticky top-0 left-0 h-screen">
//         <div>
...
//         {/* Header */}
//         <header className="bg-white shadow-sm py-4 px-6 flex justify-between items-center h-20">
//           {/* Mobile menu button */}
